...
class AgileSprintStatusSeeder extends Seeder
{
    public function run(): void
    {
        DB::statement('SET FOREIGN_KEY_CHECKS=0;');
        AgileSprintStatus::truncate();
        ...
        $statuses = [
            ...
            ['name' => 'Completed', 'code' => 'completed', 'color' => '#28a745', 'type' => 'closed', 'sort_order' => 3, 'is_default' => 0, 'is_completed' => 1, 'is_system' => 1],
        ];

        foreach ($statuses as $status) {
            AgileSprintStatus::create($status + ['is_active' => 1]);
        }
    }
}
