document.addEventListener('DOMContentLoaded', function () {
    const form = document.getElementById('projectStageForm');

    if (!form) {
        return;
    }

    const nameInput = form.querySelector('[data-project-stage-name]');
    const codeInput = form.querySelector('[data-project-stage-code]');
