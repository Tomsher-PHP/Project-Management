<div class="overflow-hidden rounded-[8px] border border-bgray-200 bg-white shadow-sm dark:border-darkblack-400 dark:bg-darkblack-600" data-workspace-chart="time-comparison" data-time-comparison-chart-url="{{ route('analytics.chart.time-comparison') }}">
    <div class="flex items-center justify-between border-b border-bgray-200 bg-bgray-50/80 px-5 py-3 dark:border-darkblack-400 dark:bg-darkblack-500/60">
        ...
        <div class="flex items-center gap-2">
            <div class="flex rounded-lg border border-bgray-300 bg-white p-0.5 dark:border-darkblack-400 dark:bg-darkblack-500" data-time-filter-group>
                ...
                <button type="button" class="active rounded-md px-3 py-1 text-[11px] font-bold transition-all text-bgray-600 hover:text-bgray-900 dark:text-bgray-300 dark:hover:text-white" data-time-filter="today" aria-pressed="true">Today</button>
                <button type="button" class="rounded-md px-3 py-1 text-[11px] font-bold transition-all text-bgray-600 hover:text-bgray-900 dark:text-bgray-300 dark:hover:text-white" data-time-filter="yesterday" aria-pressed="false">Yesterday</button>
                <button type="button" class="rounded-md px-3 py-1 text-[11px] font-bold transition-all text-bgray-600 hover:text-bgray-900 dark:text-bgray-300 dark:hover:text-white" data-time-filter="custom" aria-pressed="false">Custom</button>
            </div>
            ...
            <div class="relative h-[180px] w-[180px]">
                ...
                <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div class="flex h-[74px] w-[74px] flex-col items-center justify-center rounded-full bg-[#F8F8FC] text-center dark:bg-darkblack-500" data-chart-total>
                        <span class="text-[10px] font-bold uppercase text-bgray-700 dark:text-bgray-300">Worked</span>
