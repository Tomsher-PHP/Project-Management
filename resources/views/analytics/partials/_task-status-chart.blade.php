<div class="overflow-hidden rounded-[8px] border border-bgray-200 bg-white shadow-sm dark:border-darkblack-400 dark:bg-darkblack-600" data-workspace-chart="task-status" data-task-status-chart-url="{{ route('analytics.chart.task-status') }}">
    ...
    <div class="flex min-h-[420px] flex-col items-center justify-center p-5">
        ...
        <div data-chart-empty-state class="hidden flex h-full w-full flex-col items-center justify-center text-center">
            ...
            <h4 class="text-sm font-semibold text-bgray-900 dark:text-white">No task status data</h4>
