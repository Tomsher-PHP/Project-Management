        ...
        @foreach ($categories as $category)
            ...
            <button type="button"
                @class([
                    ...
                    'border-success-300 bg-success-50 text-success-500 dark:border-success-900/50 dark:bg-darkblack-600 dark:text-success-300' => $isActive,
                ...
                <span @class([
                    ...
                    'text-success-500 font-bold dark:text-success-300' => $category['is_completed'],
