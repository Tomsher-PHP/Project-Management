                                    ...
                                    <tr class="border-b border-bgray-300 dark:border-darkblack-400 {{ config('assets.classes.table_row_hover') }}">
                                        ...
                                        <td class="px-4 py-4">
                                            <div class="flex items-center space-x-2">
                                                @can('expense.edit')
                                                    <button type="button"
                                                        class="open-edit-expense-modal-btn inline-flex h-9 w-9 items-center justify-center rounded-lg border border-bgray-400 bg-white text-bgray-700 shadow-sm transition duration-200 hover:border-success-300 hover:bg-success-50 hover:text-success-400 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-bgray-300 dark:hover:border-success-300 dark:hover:bg-darkblack-400 dark:hover:text-success-300"
                                                        data-expense-id="{{ $expense->id }}"
                                                        data-update-url="{{ route('expenses.update', $expense->id) }}"
                                                        data-fetch-url="{{ route('expenses.edit', $expense->id) }}"
