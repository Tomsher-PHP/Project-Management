<div id="flow-switcher" class="inline-flex rounded-lg border border-bgray-500">
    <div class="relative inline-flex">
        <button data-flow="agile" class="flow-btn rounded-l-lg px-4 py-1.5 text-sm font-semibold transition text-bgray-700 dark:text-bgray-300 dark:hover:text-bgray-900">
            Agile
        </button>
    ...
    <div class="relative inline-flex">
        <button data-flow="linear" class="flow-btn rounded-r-lg px-4 py-1.5 text-sm font-semibold transition dark:text-bgray-300 dark:hover:text-bgray-700">
            Linear
        </button>
