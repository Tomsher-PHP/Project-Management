<div class="modal fixed inset-0 z-[80] hidden items-center justify-center overflow-y-auto" data-extend-time-modal id="extend_time_modal" role="dialog" aria-modal="true" aria-hidden="true">
    <div class="fixed inset-0 bg-gray-500/70 dark:bg-bgray-900/70" data-extend-time-modal-close></div>
                ...
                <form action="" method="POST" class="space-y-4 overflow-y-auto px-5 py-5" data-extend-time-form>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="rounded-lg border border-gray-200 bg-bgray-50 px-3 py-2.5 text-sm font-medium text-bgray-800 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-bgray-300" data-extend-time-current-estimate>
                                --
                            </div>
                        </div>
