                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-bgray-700 dark:text-bgray-300">
                                        You can attach multiple files. Allowed types: pdf, xls, xlsx, doc, docx, ppt, pptx, jpg, jpeg, png. Max file size: 1GB.
                                    </p>
...
<div class="w-full">
    @include('tasks.partials.task-notes-list', ['task' => $task, 'taskNotes' => $taskNotes, 'canRemove' => $canRemove, 'canCreate' => $canCreate])
</div>
