<div class="space-y-4">
    @forelse ($comments as $comment)
        <article class="p-5">
            <div class="min-w-0">
                <div class="rounded-xl bg-bgray-50 px-4 py-3 text-sm leading-6 text-bgray-700 dark:bg-darkblack-500 dark:text-bgray-300">
                    {!! nl2br(e($comment->comment)) !!}
                </div>

                <div class="mt-3 flex justify-end">
                    <div class="text-right">
                        <p class="text-xs font-semibold text-bgray-700 dark:text-bgray-300">
                            {{ $comment->user?->name ?? 'Unknown User' }}
                        </p>
                        <p class="text-[11px] font-medium text-bgray-700 dark:text-bgray-300">
