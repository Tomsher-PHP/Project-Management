                    ...
                    <aside class="flex min-h-0 flex-col overflow-hidden bg-bgray-50/60 p-6 dark:bg-darkblack-500/40">
                        <div class="min-h-0 flex-1 overflow-y-auto pr-1 space-y-5">
                            @include('tasks.partials.note-files-fields', [
                                'noteInputId' => 'task_create_note_input',
                                'noteEditorId' => 'task_create_note_editor',
                                'attachmentsInputId' => 'task_create_attachments_input',
                                'selectedFilesContainerId' => 'task_create_selected_files',
                                'errorPrefix' => 'task-create',
