...
<div class="rounded-lg bg-white p-5 dark:bg-darkblack-600">
    <div class="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-3 xl:justify-end">
            ...
            <span class="whitespace-nowrap rounded-full border border-bgray-200 bg-bgray-100 px-4 py-1 text-sm font-semibold text-bgray-700 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-bgray-300">
