                                ...
                                @if ($canViewMeetings)
                                    <li class="item px-[43px] py-[11px] {{ $isMeetingsActive ? $sidebarItemActiveClass : $sidebarItemInactiveClass }}">
                                        <a href="{{ route('meetings.index') }}">
                                            <span class="item-ico">
                                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                                                    <<<<<<< HEAD <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                                                    =======
                                                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
                                                    <line x1="16" y1="2" x2="16" y2="6" />
                                                    <line x1="8" y1="2" x2="8" y2="6" />
                                ...
                                @if ($canViewHolidays)
                                    <li class="item px-[43px] py-[11px] {{ request()->routeIs('holidays.*') ? $sidebarItemActiveClass : $sidebarItemInactiveClass }}">
                                        <a href="{{ route('holidays.index') }}">
                                            <span class="item-ico">
                                                <<<<<<< HEAD <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                                                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
                                                    <line x1="16" y1="2" x2="16" y2="6" />
                                                    <line x1="8" y1="2" x2="8" y2="6" />
                                                    <line x1="3" y1="10" x2="21" y2="10" />
