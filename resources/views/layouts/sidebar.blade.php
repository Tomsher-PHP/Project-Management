    ...
    <div class="sidebar-body overflow-style-none relative z-30 h-screen w-full overflow-y-scroll pb-[200px] pl-[48px] pt-[14px]">
                        ...
                        <a href="{{ route('roles.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2.5">
                                    ...
                                    <span class="item-text text-lg font-medium leading-none">Roles & Permissions</span>
                                </div>
                            </div>
                        </a>
                    </li>
        ...
        <div class="copy-write-text">
            ...
            <p class="text-sm font-medium text-bgray-700">
                <a href="#" target="_blank" class="border-b font-semibold hover:text-blue-600">Tomsher Technologies LLC</a>
            </p>
        </div>
    </div>
</aside>
