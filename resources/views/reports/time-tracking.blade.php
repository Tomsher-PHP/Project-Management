...
@section('page-content')
    ...
    <x-filters.drawer>
        ...
        <x-filters.multi-select name="teams" label="Teams" :options="$teams" id="time-tracking-team-filter" />
        <input type="hidden" name="user_filter_applied" id="time-tracking-user-filter-applied" value="{{ $isUserFilterApplied ? '1' : '0' }}">
        <x-filters.multi-select name="user_id" label="Users" :options="$users" id="time-tracking-user-filter" />
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const dependenciesNode = document.getElementById('task-filter-dependencies');
            const teamSelect = document.getElementById('time-tracking-team-filter');
            const userSelect = document.getElementById('time-tracking-user-filter');
            const userFilterAppliedInput = document.getElementById('time-tracking-user-filter-applied');
