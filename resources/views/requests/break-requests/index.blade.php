    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="inline-flex overflow-hidden rounded-lg border border-bgray-200 bg-white dark:border-darkblack-400 dark:bg-darkblack-600">
            @foreach ($tabs as $status => $label)
                <a href="{{ route('break-requests.index', array_merge(request()->except(['page', 'status']), ['request_status' => $status])) }}" class="px-4 py-2 text-sm font-semibold transition {{ $selectedStatus === $status ? 'bg-success-300 text-white' : 'text-bgray-600 hover:bg-bgray-50 dark:text-bgray-300 dark:hover:bg-darkblack-500' }}">
                    {{ $label }}
                </a>
            @endforeach
        </div>
                            ...
                            <tr class="group {{ config('assets.classes.table_row_hover') }}">
                                @if ($showBulkActions)
                                    <td class="border-b border-bgray-100 px-4 py-4 dark:border-darkblack-400">
                                        @if ($breakRequest->isPending() && $canAccess)
                                ...
                                <td class="border-b border-bgray-100 px-4 py-4 dark:border-darkblack-400">
                                    <span class="min-w-[120px] text-sm text-bgray-700 dark:text-bgray-300">@appDate($breakRequest->work_date)</span>
                                </td>
                                <td class="border-b border-bgray-100 px-4 py-4 dark:border-darkblack-400">
                                ...
                                <td class="border-b border-bgray-100 px-4 py-4 dark:border-darkblack-400">
                                    <div class="min-w-[180px] text-sm text-bgray-700 dark:text-bgray-300">
                                ...
                                <td class="border-b border-bgray-100 px-4 py-4 dark:border-darkblack-400">
                                    <span class="min-w-[90px] text-sm text-bgray-700 dark:text-bgray-300">{{ formatSecondsToHMS($breakRequest->duration_seconds) }}</span>
                                </td>
                                <td class="border-b border-bgray-100 px-4 py-4 dark:border-darkblack-400">
                                    <div class="min-w-[260px] text-sm text-bgray-700 dark:text-bgray-300">
            ...
            <div class="relative z-10 w-full max-w-lg rounded-[8px] bg-white shadow-2xl dark:bg-darkblack-600">
                <div class="flex items-center justify-between border-b border-bgray-200 px-5 py-4 dark:border-darkblack-400">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-bgray-700 dark:text-bgray-300" data-break-request-reject-title></p>
                    </div>
                ...
                <form method="POST" action="#" class="space-y-4 px-5 py-5" data-break-request-reject-form>
                    ...
                    <div>
                        <label for="break-request-rejection-reason" class="mb-2 block text-sm font-medium text-bgray-700 dark:text-bgray-300">
                    ...
                    <div class="flex justify-end gap-3 border-t border-bgray-100 pt-4 dark:border-darkblack-400">
                        <button type="button" class="rounded-lg border border-bgray-200 bg-white px-4 py-2 text-sm font-medium text-bgray-700 transition hover:border-bgray-300 hover:text-bgray-900 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-bgray-300" data-break-request-reject-close>
                            Cancel
                        </button>
