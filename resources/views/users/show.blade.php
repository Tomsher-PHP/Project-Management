                        ...
                        <div class="progess-bar mb-0 flex justify-center md:mb-[13px] xl:mb-0">
                            <div class="bonus-per relative">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="80px" height="80px">
                                    <circle style="stroke-dashoffset: calc(215 - 215 * ({{ $profile['percentage'] }} / 100));" cx="40" cy="40" r="35" stroke-linecap="round" />
                                </svg>
                            </div>
                        </div>
        ...
        <div class="tab-content col-span-9 px-10 py-8">
            ...
            <div id="overViewTab" class="tab-pane active">
                <div class="grid grid-cols-12 gap-8">
                    <!-- LEFT SIDE -->
                    <div class="col-span-12 xl:col-span-8 space-y-10">
                        <!-- BASIC INFO -->
                        <div>
