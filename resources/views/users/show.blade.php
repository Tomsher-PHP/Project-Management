...
@section('page-content')
        ...
        <div class="grid grid-cols-1 rounded-xl bg-white dark:bg-darkblack-600 xl:grid-cols-12">
            ...
            <aside class="col-span-3 border-r border-bgray-200 dark:border-darkblack-400">
                ...
                <div class="px-4 py-6">
                    ...
                    <!-- Shift Calendar Tab -->
                    <div data-tab="shiftCalendarTab" class="tab group flex gap-x-4 rounded-lg p-4 transition-all">
                        <div class="tab-icon inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-bgray-100 transition-all">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="3" y="4" width="18" height="18" rx="2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M16 2V6M8 2V6M3 10H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <div>
                            <h4 class="text-base font-bold text-bgray-900 dark:text-white">
            ...
            <div class="tab-content col-span-9 px-10 py-8">
                @include('users.partials.show-tabs.overview')
                @include('users.partials.show-tabs.notifications')
                @include('users.partials.show-tabs.general-settings')
                @include('users.partials.show-tabs.change-password')
                @include('users.partials.show-tabs.shift-calendar')
                @include('users.partials.show-tabs.kpi')
            </div>
        </div>
    ...
    @if ($errors->any())
        <script>
            localStorage.setItem('activeTab', 'overViewTab');
        </script>
    @endif
@endsection
...
@push('scripts')
    ...
    @vite('resources/js/modules/users/user-shift.js')
