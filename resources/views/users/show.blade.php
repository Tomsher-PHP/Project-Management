                ...
                <aside class="col-span-3 border-r border-bgray-200 dark:border-darkblack-400">
                    ...
                    <div class="px-4 py-6">
                        ...
                        <div data-tab="changePasswordTab" class="tab group flex gap-x-4 rounded-lg p-4 transition-all">
                            <div class="tab-icon inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-bgray-100 transition-all">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15 12H18M18 12C18 13.6569 16.6569 15 15 15H9C7.34315 15 6 13.6569 6 12V6C6 4.34315 7.34315 3 9 3H15C16.6569 3 18 4.34315 18 6V12Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                </svg>
                            </div>
                            <div>
                                <h4 class="text-base font-bold text-bgray-900 dark:text-white">
                        ...
                        <div data-tab="kpiTab" class="tab group flex gap-x-4 rounded-lg p-4 transition-all">
                            <div class="tab-icon inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-bgray-100 transition-all">
                                ...
                                <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path d="M4 19V10M10 19V5M16 19V13M22 19V3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                </svg>
                            </div>
                            <div>
                                <h4 class="text-base font-bold text-bgray-900 dark:text-white">
                                ...
                                <div class="progess-bar mb-0 flex justify-center md:mb-[13px] xl:mb-0">
                                    <div class="bonus-per relative">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="80px" height="80px">
                                            ...
                                            <circle style="stroke-dashoffset: {{ $offset }};" cx="40" cy="40" r="35" stroke-linecap="round" />
                                        </svg>
                                    </div>
                                </div>
                            ...
                            @foreach ($userNotificationSettings as $key => $setting)
                                <div class="!mt-0 grid grid-cols-12 items-center px-4 border-b border-bgray-200 dark:border-darkblack-400">
                                    ...
                                    <div class="col-span-3 flex justify-center items-center">
                                        <button type="button" class="switch-btn relative inline-flex h-5 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors
                                    {{ isset($userSettings[$setting['action']]) && $userSettings[$setting['action']]->in_app ? 'active' : '' }}" role="switch" data-user="{{ $user->id }}" data-action="{{ $setting['action'] }}" data-field="in_app" aria-checked="{{ isset($userSettings[$setting['action']]) && $userSettings[$setting['action']]->in_app ? 'true' : 'false' }}">
                                    ...
                                    <div class="col-span-3 flex justify-center items-center">
                                        <button type="button" class="switch-btn relative inline-flex h-5 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors
                                    {{ isset($userSettings[$setting['action']]) && $userSettings[$setting['action']]->mail ? 'active' : '' }}" role="switch" data-user="{{ $user->id }}" data-action="{{ $setting['action'] }}" data-field="mail" aria-checked="{{ isset($userSettings[$setting['action']]) && $userSettings[$setting['action']]->mail ? 'true' : 'false' }}">
                            ...
                            <div class="flex-1 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                                ...
                                @if (!auth()->user()->is_super_admin)
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <input type="password" name="current_password" @if (!auth()->user()->is_super_admin) required @endif class="w-full rounded-lg border border-gray-300 p-2 focus:border-success-300 focus:ring-0 bg-white text-gray-900 dark:bg-darkblack-500 dark:text-white dark:border-darkblack-400">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <input type="password" name="new_password" required class="w-full rounded-lg border border-gray-300 p-2 focus:border-success-300 focus:ring-0 bg-white text-gray-900 dark:bg-darkblack-500 dark:text-white dark:border-darkblack-400">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <input type="password" name="new_password_confirmation" required class="w-full rounded-lg border border-gray-300 p-2 focus:border-success-300 focus:ring-0 bg-white text-gray-900 dark:bg-darkblack-500 dark:text-white dark:border-darkblack-400">
