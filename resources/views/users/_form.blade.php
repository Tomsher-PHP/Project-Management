<form action="{{ isset($user) ? route('users.update', $user->id) : route('users.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="pb-8 dark:border-darkblack-400">
        <h3 class="text-xl font-bold text-gray-800 border-b pb-4 mb-6 dark:border-darkblack-400 dark:text-white">
            Basic Information
        </h3>

        <div class="flex flex-col md:flex-row gap-8 dark:text-white items-start">
            <!-- Profile Image -->
    ...
    <!-- ================= KPI ================= -->
    <div class="mt-5">
        <h3 class="text-xl font-bold text-gray-800 border-b pb-4 dark:border-darkblack-400 dark:text-white mb-6">
            KPI Information
        </h3>
