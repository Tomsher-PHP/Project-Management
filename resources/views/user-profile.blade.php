            ...
            <div class="xl:col-span-4 lg:col-span-5">
                <div class="card text-center p-6 mb-6">
                    ...
                    <div class="text-start mt-6">
                        ...
                        <p class="text-zinc-400 mb-3"><strong>Full Name :</strong> <span class="ms-2">Tosha
                                K. Minner</span></p>

                        <p class="text-zinc-400 mb-3"><strong>Mobile :</strong><span class="ms-2">(123) 123
                                1234</span></p>
                ...
                <div class="card p-6">
                    ...
                    <div class="divide-y dark:divide-gray-700">
                        <div class="overflow-hidden py-2.5 relative">
                            <div class="block float-left me-3.5 w-10"><img src="assets/images/users/avatar-2.jpg"
                        ...
                        <div class="overflow-hidden py-2.5 relative">
                            <div class="block float-left me-3.5 w-10"><img src="assets/images/users/avatar-3.jpg"
                                    class="rounded-full" alt=""></div>
                        ...
                        <div class="overflow-hidden py-2.5 relative">
                            <div class="block float-left me-3.5 w-10"><img src="assets/images/users/avatar-4.jpg"
                                    class="rounded-full" alt=""></div>
                        ...
                        <div class="overflow-hidden py-2.5 relative">
                            <div class="block float-left me-3.5 w-10"><img src="assets/images/users/avatar-5.jpg"
                                    class="rounded-full" alt=""></div>
                        ...
                        <div class="overflow-hidden pt-2.5 relative">
                            <div class="block float-left me-3.5 w-10"><img src="assets/images/users/avatar-6.jpg"
                                    class="rounded-full" alt=""></div>
                    ...
                    <div data-fc-type="tab">
                        ...
                        <div class="mt-3">
                            <div id="fill-and-justify-1" role="tabpanel" aria-labelledby="fill-and-justify-item-1">
                                                ...
                                                <tbody class="">
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="flex p-2 whitespace-nowrap">
                                                            ...
                                                            <span class="ms-2 font-medium">Halette
                                                                Boivin</span>
                                                        </td>
                                                        <td class="p-2 whitespace-nowrap">App design and
                                                            development</td>
                                                        <td class="p-2 whitespace-nowrap">01/01/2022</td>
                                                        <td class="p-2 whitespace-nowrap">10/12/2023</td>
                                                        <td class="p-2 whitespace-nowrap">
                                                            <span
                                                                class="bg-info/20 text-info py-0.5 px-1 rounded text-xs">Work
                                                                in Progress</span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="flex p-2 whitespace-nowrap">
                                                            ...
                                                            <span class="ms-2 font-medium">Durandana
                                                                Jolicoeur</span>
                                                        </td>
                                                        <td class="p-2 whitespace-nowrap">Coffee detail page -
                                                            Main Page</td>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="flex p-2 whitespace-nowrap">
                                                            ...
                                                            <span class="ms-2 font-medium">Lucas
                                                                Sabourin</span>
                                                        </td>
                                                        <td class="p-2 whitespace-nowrap">Poster illustation
                                                            design</td>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="flex p-2 whitespace-nowrap">
                                                            ...
                                                            <span class="ms-2 font-medium">Donatien
                                                                Brunelle</span>
                                                        </td>
                                                        <td class="p-2 whitespace-nowrap">Drinking bottle
                                                            graphics</td>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="flex p-2 whitespace-nowrap">
                                                            ...
                                                            <span class="ms-2 font-medium">Karel
                                                                Auberjo</span>
                                                        </td>
                                                        <td class="p-2 whitespace-nowrap">Landing page design
                                                            - Home</td>
                                ...
                                <h5 class="text-base uppercase mt-9 mb-2.5"><i
                                        class="ri-macbook-line me-1.5"></i>Experience</h5>

                                <div class="py-5 relative">
                                    <div class="relative">
                                        <div
                                            class="absolute bg-light bottom-0 left-[9px] top-5 w-0.5 z-0 dark:bg-gray-700">
                                        </div>
                                        <i
                                        ...
                                        <div class="ms-8">
                                            ...
                                            <p class="text-sm">websitename.com <span class="ms-3 text-xs">Year: 2015 -
                                                    18</span></p>
                                            <p class="text-gray-500 mt-3 pb-6">Everyone realizes why a new
                                                common language
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="ms-8">
                                            ...
                                            <p class="text-sm">Software Inc. <span class="ms-3 text-xs">Year: 2012 -
                                                    15</span></p>
                                            <p class="text-gray-500 mt-3 pb-6">Everyone realizes why a new
                                                common language
                                                would be desirable: one could refuse to pay expensive
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="ms-8">
                                            ...
                                            <p class="text-sm">Coderthemes Design LLP <span class="ms-3 text-xs">Year:
                                                    2010 - 12</span></p>
                                            <p class="text-gray-500 mt-3 pb-6">Everyone realizes why a new
                                                common language
                                                would be desirable: one could refuse to pay expensive
                            ...
                            <div id="fill-and-justify-2" class="hidden" role="tabpanel"
                                ...
                                <div class="border rounded mt-3 mb-6 dark:border-gray-600">
                                    <form action="#" class="comment-area-box">
                                        ...
                                        <div class="p-2 bg-light flex justify-between items-center dark:bg-gray-700">
                                            ...
                                            <button type="submit"
                                                class="btn btn-sm bg-dark text-white !text-base dark:bg-gray-600">Post</button>
                                        </div>
                                    </form>
                                </div><!-- End Post Box -->
                                ...
                                <div class="border rounded p-3 mb-3 dark:border-gray-600">
                                    <div class="flex">
                                        <img class="me-3 rounded-full h-8" src="assets/images/users/avatar-4.jpg"
                                    ...
                                    <div class="-mx-3 p-3 mt-6 bg-light dark:bg-gray-700">
                                        <div class="flex">
                                            <img class="me-3 rounded-full h-8" src="assets/images/users/avatar-3.jpg"
                                                alt="Generic placeholder image">
                                            <div>
                                                <h5 class="text-base mb-1">Jeremy Tomlinson <small
                                                        class="text-sm text-gray-500">about 2 minuts
                                                        ago</small></h5>
                                        ...
                                        <div class="flex mt-3">
                                            <a class="pe-3" href="#">
                                                <img src="assets/images/users/avatar-1.jpg" class="rounded-full h-8"
                                                    alt="Generic placeholder image">
                                            </a>
                                            <div class="w-full">
                                    ...
                                    <div class="mt-2">
                                        <a href="javascript: void(0);"
                                            class="btn btn-sm !text-sm text-danger items-center"><i
                                ...
                                <div class="border rounded p-3 mb-6 dark:border-gray-600">
                                    ...
                                    <p class="mb-4">Story based around the idea of time lapse, animation to
                                        post soon!</p>

                                    <div class="flex gap-1.5 items-center">
                                        <img src="assets/images/small/small-1.jpg" alt="post-img"
                                            class="rounded-md h-16">
                                ...
                                <div class="border rounded p-3 mb-6 dark:border-gray-600">
                                    <div class="flex">
                                        <img class="me-3 rounded-full h-8" src="assets/images/users/avatar-6.jpg"
                                            alt="Generic placeholder image">
                                        <div>
                                    ...
                                    <p class="text-sm mb-4">The parallax is a little odd but O.o that house
                                        build is awesome!!</p>
                                ...
                                <div class="text-center">
                                    <a href="javascript:void(0);" class="text-danger"><i
                                            class="ri-loader-fill me-1.5"></i> Load more </a>
                                </div><!-- End Loader -->
                                ...
                                <form>
                                    ...
                                    <div class="grid md:grid-cols-2 grid-cols-1 gap-x-2.5">
                                        ...
                                        <div class="md:col-span-2">
                                            <div class="mb-6 space-y-2">
                                                <label for="userbio"
                                                    class="font-semibold text-sm text-gray-500">Bio</label>
                                    ...
                                    <div class="grid md:grid-cols-2 grid-cols-1 gap-x-2.5">
                                        <div class="">
                                            <div class="mb-6 space-y-2">
                                                ...
                                                <span class="text-gray-500"><small>If you want to change email
                                                        please <a href="javascript: void(0);"
                                                            class="text-primary">click</a>
                                                        here.</small></span>
                                            </div>
                                        </div>
                                        <div class="">
                                            <div class="mb-6 space-y-2">
                                                ...
                                                <span class="text-gray-500"><small>If you want to change
                                                        password please <a href="javascript: void(0);"
                                                            class="text-primary">click</a>
                                                        here.</small></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="">
                                            <div class="mb-6 space-y-2">
                                                <label for="companyname"
                                                    class="font-semibold text-sm text-gray-500">Company
                                                    Name</label>
                                    ...
                                    <div class="text-end">
                                        <button type="submit" class="btn bg-success text-white mt-3"><i
                                                class="ri-save-line me-1"></i> Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
