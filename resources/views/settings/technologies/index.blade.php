                                ...
                                <tr class="border-b border-bgray-300 dark:border-darkblack-400 {{ config('assets.classes.table_row_hover') }}">
                                    ...
                                    <td class="px-6 py-5 xl:w-[165px] xl:px-0">
                                        <div class="flex w-full items-center space-x-2">
                                            @can('technology.edit')
                                                <a href="javascript:void(0)" class="edit-record" data-modal="multi-step-modal" data-url="{{ route('settings.technologies.update', $technology->id) }}" data-name="{{ $technology->name }}" data-sort_order="{{ $technology->sort_order }}" data-method="PUT" data-module="Technology">
