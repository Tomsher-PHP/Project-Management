...
@section('page-content')
    <!-- Page starts -->
        <div class="mb-6 flex flex-wrap items-center gap-3">
            ...
            @can('kpi.create')
                <x-button.create-button type="button" class="modal-open" data-target="#multi-step-modal" data-module="KPI" data-url="{{ route('settings.kpis.store') }}" data-method="POST" label="KPI" />
            @endcan
