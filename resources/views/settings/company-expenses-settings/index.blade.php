...
@php
    $tabs = [
        [
            'key' => 'payment-modes',
            'label' => 'Payment Modes',
            'url' => route('settings.expense-payment-modes.index'),
            'permission' => 'company_expenses.view',
        ],
        [
            'key' => 'service-providers',
            'label' => 'Service Providers',
            'url' => route('settings.expense-service-providers.index'),
            'permission' => 'company_expenses.view',
        ],
        [
            'key' => 'categories',
...
@section('page-content')
    ...
    <x-form-modal modalId="multi-step-modal" :module="$entityLabel" formId="companyExpensesSettingsForm" :action="$storeRoute" :button="'Create ' . $entityLabel">
        <div>
