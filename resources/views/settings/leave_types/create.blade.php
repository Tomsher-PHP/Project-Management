                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="4" placeholder="Enter a description for this leave type..."
                                class="w-full rounded-lg border border-bgray-200 bg-white px-4 py-3 text-sm text-bgray-900 outline-none focus:border-success-300 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-white">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-xs text-red-500">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="rounded-lg border border-bgray-200 p-4 dark:border-darkblack-400">
                            <div class="flex items-start gap-3">
                                ...
                                <input type="checkbox" id="is_file_upload_required" name="is_file_upload_required"
                                    value="1" {{ old('is_file_upload_required') ? 'checked' : '' }}
                        ...
                        {{-- Status --}}
                        <div class="md:col-span-2">
                            <label for="status" class="mb-2 block text-sm font-medium text-bgray-700 dark:text-bgray-200">
                                Status
                            </label>
