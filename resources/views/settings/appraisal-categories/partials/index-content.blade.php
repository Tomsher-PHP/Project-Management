                    ...
                    <table class="w-full">
                        <tr class="border-b border-bgray-300 dark:border-darkblack-400">
                            ...
                            <td class="px-6 py-5 xl:w-[150px] xl:px-0">
                                <span class="text-base font-medium text-bgray-600 dark:text-bgray-50">Code</span>
                            </td>
                        ...
                        @forelse ($appraisalCategories as $appraisalCategory)
                            ...
                            <tr class="border-b border-bgray-300 dark:border-darkblack-400 {{ config('assets.classes.table_row_hover') }}">
                                ...
                                <!-- code -->
                                <td>
                                    <span class="text-base font-medium text-bgray-600 dark:text-bgray-50">{{ $appraisalCategory->code }}</span>
                                </td>
                                <td class="px-6 py-5 xl:px-0">
                                ...
                                <td class="px-6 py-5 xl:w-[150px] xl:px-0">
                                    <button type="button" @cannot('appraisal_settings.edit') disabled @endcannot class="default-toggle switch-btn {{ $appraisalCategory->is_default ? 'active' : '' }} relative inline-flex h-5 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent text-center transition-colors duration-200 ease-in-out focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed" data-id="{{ $appraisalCategory->id }}" data-url="{{ route('settings.appraisal.toggleDefault') }}" data-entity="default setting" role="switch" aria-checked="{{ $appraisalCategory->is_default ? 'true' : 'false' }}">
