                ...
                <div class="max-w-[450px] m-auto pt-24 pb-16">
                    <header class="text-center mb-8">
                        ...
                        <p class="font-urbanis text-base font-medium text-bgray-600 dark:text-bgray-50">
                            All your projects, one powerful workspace
                        </p>
                    </header>
                    ...
                    <form method="POST" action="{{ route('login.post') }}">
                        @csrf
                        <div class="mb-4">
                            <input type="text" name="email" class="text-bgray-800 text-base border border-bgray-300 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-white h-14 w-full focus:border-success-300 focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base" placeholder="Email" />
                        </div>
                        <div class="mb-6 relative">
                            <input type="password" name="password" class="text-bgray-800 text-base border border-bgray-300 dark:border-darkblack-400 dark:bg-darkblack-500 dark:text-white h-14 w-full focus:border-success-300 focus:ring-0 rounded-lg px-4 py-3.5 placeholder:text-bgray-500 placeholder:text-base" placeholder="Password" />
                ...
                <div>
                    <div class="text-center max-w-lg px-1.5 m-auto">
                        ...
                        <p class="text-bgray-600 dark:text-bgray-50 text-sm font-medium">
                            Streamline workflows, assign tasks, monitor deadlines, and keep your team aligned —
                            everything you need to move projects forward with confidence.
                        </p>
                    </div>
                </div>
            </div>
