...
<div class="flex flex-col gap-2">
    ...
    <input type="email" id="{{ $id }}" name="{{ $name }}" value="{{ $value }}" placeholder="{{ $placeholder }}" class="w-full rounded-lg border p-2 focus:border-success-300 focus:ring-0 bg-white text-gray-900 dark:bg-darkblack-500 dark:text-white {{ $inputClasses }}" oninput="this.value = this.value.toLowerCase()" @disabled($disabled)>
