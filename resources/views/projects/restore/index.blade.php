    ...
    <main class="w-full px-6 pb-6 pt-[100px] sm:pt-[120px] xl:px-[48px] xl:pb-[48px]">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-3">
                <button type="button" class="rounded-md bg-success-300 px-4 py-1.5 text-sm font-semibold text-white transition duration-200 hover:bg-success-400 disabled:cursor-not-allowed disabled:opacity-50" data-project-restore-bulk-button disabled>
                    Bulk Restore
                </button>

                <form method="POST" action="{{ route('projects.restore.bulk') }}" class="hidden" data-project-restore-bulk-form>
                    @csrf
                    <div data-project-restore-bulk-hidden-inputs></div>
                </form>
            </div>
        </div>
                            ...
                            <table class="w-full">
                                <tr class="border-b border-bgray-300 dark:border-darkblack-400">
                                    <td class="px-6 py-5 xl:px-0">
                                        <input type="checkbox" class="h-4 w-4 rounded border-bgray-300 text-success-300 focus:ring-success-300 dark:border-darkblack-400 dark:bg-darkblack-500" data-project-restore-select-all>
                                    </td>
                                    <td class="px-6 py-5 xl:px-0">
                                    ...
                                    <td class="px-6 py-5 xl:px-0">
                                        <span class="text-base font-medium text-bgray-600 dark:text-bgray-50">Deleted At</span>
                                    </td>
                                    <td class="px-6 py-5 xl:px-0">
                                ...
                                @forelse ($projects as $project)
                                    <tr class="border-b border-bgray-300 dark:border-darkblack-400">
                                        <td class="px-6 py-5 xl:px-0">
                                            <input type="checkbox" value="{{ $project->id }}" class="h-4 w-4 rounded border-bgray-300 text-success-300 focus:ring-success-300 dark:border-darkblack-400 dark:bg-darkblack-500" data-project-restore-checkbox>
                                        </td>
                                        <td class="px-6 py-5 xl:px-0">
                                ...
                                @empty
                                    <x-table-no-data col-span="7" message="No deleted projects found." />
                                @endforelse
                            </table>
                        </div>
...
@push('scripts')
    @vite('resources/js/modules/projects/project-restore.js')
@endpush
