...
<div class="space-y-3" data-project-tasks-root data-default-sprint-id="{{ $taskCreateDefaultSprintId ?? '' }}">
    ...
    <div class="modal fixed inset-0 z-[80] hidden overflow-y-auto" data-project-task-log-modal>
        <div class="fixed inset-0 bg-gray-500/70 dark:bg-bgray-900/70" data-project-task-log-close></div>

        <div class="relative flex min-h-full items-center justify-center p-4 sm:p-6">
            <div class="relative z-10 w-full max-w-7xl" data-project-task-log-content></div>
        </div>
    </div>
