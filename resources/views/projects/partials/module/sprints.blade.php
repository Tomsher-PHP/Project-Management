<div class="space-y-3 border-l-2 border-dashed border-bgray-200 pl-4 transition duration-200 dark:border-darkblack-400 md:pl-6" data-project-sprint-list @can('project_sprint.edit') data-reorder-url="{{ route('projects.modules.sprints.reorder', [$project, $module]) }}" @endcan>
            ...
            <div class="flex flex-col gap-3 px-4 py-3 lg:flex-row lg:items-center lg:justify-between">
                <div class="flex items-start gap-3">
                    @can('project_sprint.edit')
                        <button type="button" class="mt-0.5 inline-flex h-10 w-10 shrink-0 cursor-move items-center justify-center rounded-xl border border-bgray-200 bg-white text-bgray-500 transition duration-200 dark:border-darkblack-400 dark:bg-darkblack-600 dark:text-bgray-300" data-project-sprint-drag-handle>
                ...
                <div class="flex flex-wrap items-center gap-2 lg:justify-end">
                    ...
                    @can('project_sprint.edit')
                        <button type="button" class="project-sprint-builder-edit inline-flex h-9 w-9 items-center justify-center rounded-lg border border-bgray-200 bg-white text-bgray-600 transition duration-200 hover:border-success-300 hover:bg-success-50 hover:text-success-400 dark:border-darkblack-400 dark:bg-darkblack-600 dark:text-bgray-300 dark:hover:border-success-300 dark:hover:bg-darkblack-400 dark:hover:text-success-300"
                            data-project-sprint-id="{{ $projectSprint->id }}" data-project-module-id="{{ $projectSprint->project_module_id }}" data-project-module-name="{{ $module->name }}" data-project-sprint-load-url="{{ route('projects.modules.sprints.index', [$project, $module]) }}" title="Edit sprint">
