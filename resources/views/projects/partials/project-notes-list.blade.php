<div id="project-notes-history">
    <div class="flex items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center justify-end gap-3">
            ...
            @if (!empty($canCreate))
                <button type="button" class="inline-flex items-center gap-2 rounded-lg bg-success-300 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition duration-200 hover:bg-success-400" data-project-note-modal-open>
