...
<article class="rounded-2xl border border-bgray-200 bg-white p-4 shadow-sm dark:border-darkblack-400 dark:bg-darkblack-600" data-project-checklist-card data-client-key="{{ $clientKey }}">
    <div class="flex flex-col gap-3 border-b border-bgray-200 pb-4 dark:border-darkblack-400 md:flex-row md:items-start md:justify-between">
        ...
        <div class="flex items-center gap-2 self-start md:self-auto">
            <button
                type="button"
                class="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-bgray-200 bg-white text-bgray-500 transition duration-200 hover:bg-bgray-50 dark:border-darkblack-400 dark:bg-darkblack-600 dark:text-bgray-300 dark:hover:bg-darkblack-500"
                data-project-checklist-toggle
                data-checklist-index="{{ $checklistIndex }}"
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <input
                                ...
                                class="w-full rounded-lg border {{ $qError ? 'border-red-500' : 'border-bgray-200' }} bg-white px-3 py-2.5 text-sm text-bgray-900 focus:border-success-300 focus:ring-0 dark:border-darkblack-400 dark:bg-darkblack-600 dark:text-white"
