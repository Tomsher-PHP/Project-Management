...
<section class="grid gap-6 xl:grid-cols-[75%_25%] rounded-2xl bg-white p-6 shadow-sm mt-4">
   Content for second section goes here. You can replace this with your actual content.
 </section>
