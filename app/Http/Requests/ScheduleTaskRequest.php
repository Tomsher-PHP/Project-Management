...
class ScheduleTaskRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'due_after_seconds' => ['required', 'integer', 'min:1'],
    ...
    public function messages(): array
    {
        return [
            ...
            'due_after_seconds.required' => 'Please specify a due after duration.',
            'due_after_seconds.min' => 'Please specify a due after duration.',
