...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('appraisal')->as('appraisal.')->group(function () {
        ...
        Route::get('/{appraisal}/manage-reviewers', [AppraisalController::class, 'manageReviewersData'])->middleware('permission.type:appraisal.create')->name('manage-reviewers.data');
        Route::post('/{appraisal}/reviewers/add', [AppraisalController::class, 'addReviewer'])->middleware('permission.type:appraisal.create')->name('manage-reviewers.add');
        Route::post('/{appraisal}/reviewers/{reviewer}/change', [AppraisalController::class, 'changeReviewer'])->middleware('permission.type:appraisal.create')->name('manage-reviewers.change');
        Route::delete('/{appraisal}/reviewers/{reviewer}', [AppraisalController::class, 'removeReviewer'])->middleware('permission.type:appraisal.create')->name('manage-reviewers.remove');
